...
- Market validation: `docs/internal/market-gap-validation.md`
- Product requirements: `docs/internal/product-requirements.md`
- Architecture: `docs/internal/architecture.md`
- Evaluation protocol: `docs/internal/live-evaluation-protocol.md`
- Results matrix: `docs/internal/results-matrix.md`
- Polyglot toolchain decision: `docs/internal/decisions/polyglot-toolchain-decision.md`
- Public API parity matrix: `docs/internal/notes/api-parity-matrix.md`
- Progress tracker: `docs/internal/progress-tracker.md`
...
- `docs/internal/notes/provider-extractor-notes.md` records the official source references and raw usage field mappings for OpenAI Responses, OpenAI Embeddings, xAI Responses, OpenAI-compatible chat providers, Cohere, Gemini, Bedrock Converse, and Bedrock InvokeModel.
...
- Framework adapter notes in `docs/internal/notes/framework-adapter-notes.md`.
...
- `docs/internal/process/alpha-smoke-runbook.md` documents live gates, privacy rules, and
  the product-truth loop.
- `docs/internal/process/invoice-dashboard-comparison.md` defines the invoice/dashboard
...
- `scripts/compare_invoice_dashboard.py`,
  ...
  `docs/internal/reports/2026-05-26-invoice-dashboard-comparison-sample.md` provide a
...
- `scripts/run_vercel_alpha_smoke.mjs` and
  ...
  core dependencies.
- `docs/internal/reports/2026-05-26-alpha-smoke-live-no-credentials.md` records the
...
Completed for this planning pass. The tracker in `docs/internal/progress-tracker.md` carries the latest evidence and next actions.
