...
See `docs/internal/results-matrix.md` for the full table.
...
- Live fixture tests show no package can correctly price the hard cases in `docs/internal/live-evaluation-protocol.md`.
