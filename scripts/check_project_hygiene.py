...
REQUIRED_FILES = [
    ...
    "scripts/check_official_price_snapshots.py",
    ...
    "scripts/build_price_catalog_artifacts.py",
    ...
    "docs/internal/reports/2026-07-15-product-expansion-implementation-plan.md",
    "docs/internal/reports/2026-07-15-product-market-and-distribution-assessment.md",
    "docs/internal/reports/2026-07-18-product-expansion-verification.md",
    "docs/internal/decisions/2026-07-15-batch-and-expansion-contracts.md",
    "docs/internal/decisions/2026-07-18-playground-design-spec.md",
    "docs/internal/process/2026-07-18-distribution-measurement-runbook.md",
    "docs/guides/2026-07-18-product-expansion-quickstart.md",
    "docs/guides/2026-07-18-integration-case-study-template.md",
    "docs/guides/external-fixture-contributions.md",
    "docs/generated/conformance-report.json",
    "docs/generated/conformance-report.md",
    "docs/reference/catalog-performance-budgets.md",
    "fixtures/expansion/cases.json",
    ...
    "schemas/expansion-fixture.schema.json",
    "schemas/reconciliation.schema.json",
    "packages/python/runcost/expansion.py",
    "packages/python/runcost/price_resolver.py",
    "packages/javascript/core/browser.js",
    "packages/go/ledger/expansion.go",
    "packages/go/ledger/price_resolver.go",
    "scripts/check_browser_entrypoint.py",
    "scripts/check_catalog_manifest.py",
    "scripts/check_catalog_performance.py",
    "scripts/check_cli_activation.py",
    "scripts/check_expansion_examples.py",
    "scripts/check_external_fixture_workflow.py",
    "scripts/check_openai_expansion_smoke.py",
    "scripts/check_playground_site.py",
    "scripts/check_product_expansion.py",
    "scripts/generate_conformance_report.py",
    "scripts/run_conformance.py",
    "scripts/run_openai_expansion_smoke.py",
    "schemas/price-resolution.schema.json",
    "playground/package.json",
    "playground/src/pages.jsx",
]
...
PUBLIC_API_NAMES = [
    ...
    "fromVercelAISDKStreamTranscribeFinish",
    "FromVercelAISDKStreamTranscribeFinish",
    ...
    "extractGeminiLiveUsage",
    "extract_google_interactions_usage",
    "extractGoogleInteractionsUsage",
...
def check_package_metadata() -> None:
    ...
    assert_true(
        "check_external_price_resolution.py" in scripts.get("test", "")
        and "check_official_price_snapshots.py" in scripts.get("test", ""),
        "root npm test must run external resolution and official snapshot checks",
    )
    assert_true(
        "check_external_price_resolution.py" in scripts.get("check:prices", "")
        and "check_official_price_snapshots.py" in scripts.get("check:prices", ""),
        "root check:prices must run external resolution and official snapshot checks",
    )
    assert_true(
    ...
    assert_true(
        "build_price_catalog_artifacts.py" in scripts.get("prices:build-artifacts", ""),
        "root prices:build-artifacts must run the caller-owned catalog artifact builder",
    )
    assert_true(
...
def check_public_api_artifacts() -> None:
    ...
    go_source = "\n".join(
        [
            (ROOT / "packages/go/ledger/ledger.go").read_text(encoding="utf-8"),
            (ROOT / "packages/go/ledger/expansion.go").read_text(encoding="utf-8"),
            (ROOT / "packages/go/ledger/price_resolver.go").read_text(encoding="utf-8"),
        ]
    )
    go_examples = (ROOT / "packages/go/ledger/example_test.go").read_text(encoding="utf-8")

    assert_true(
        'DEFAULT_EXTERNAL_PRICE_SOURCES: readonly ["genai-prices", "models.dev", "litellm"]' in typescript,
        "TypeScript external source order must match the runtime resolver order",
    )
