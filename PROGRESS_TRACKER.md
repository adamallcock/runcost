...
- Advanced polyglot generated-artifact hardening:
  ...
  - `scripts/generate_contract_docs.py` also generates `docs/generated/warning-coverage.md` from `schemas/taxonomy.json` and fixture warning metadata, currently showing 16 of 19 warning codes fixture-backed;
